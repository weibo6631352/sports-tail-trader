...
from polymarket_trader.quant.tail import SportsMarketFamily, SportsMarketSide, SportsMarketType
...
def _market_family(market: Market, text: str) -> SportsMarketFamily:
    ...
    if not _is_tennis_text(combined_text):
        from polymarket_trader.quant.series import SeriesSubType, classify_series_sub_type
