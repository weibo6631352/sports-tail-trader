...
from polymarket_trader.quant.series.decide import (
    decide_series_entry,
    resolve_series_reject_label,
    resolve_series_sub_type_label,
)
from polymarket_trader.quant.series.evaluator import (
    SeriesEvaluatorInputs,
    evaluate_series_opportunity,
)
from polymarket_trader.quant.series.handicap_model import (
    series_handicap_cover_probability,
    single_game_cover_probability,
)
from polymarket_trader.quant.series.handicap_outcome import (
    HandicapBet,
    HandicapScope,
    parse_handicap_outcome,
)
from polymarket_trader.quant.series.match import (
    GameOdds,
    GameSpreads,
...
from polymarket_trader.quant.series.risk import (
    SeriesSubTypeRiskConfig,
    check_series_entry_risk,
)
from polymarket_trader.quant.series.single_game_prob import (
    SingleGameProb,
    derive_single_game_prob,
)
from polymarket_trader.quant.series.team_resolver import TeamSide, resolve_series_team
from polymarket_trader.quant.series.total_games_model import (
    prob_over,
    prob_under,
    push_probability,
    total_games_distribution,
)
from polymarket_trader.quant.series.total_games_outcome import (
    Direction,
    parse_total_games_outcome,
)
from polymarket_trader.quant.series.types import (
    SeriesCandidate,
    SeriesEvaluation,
    SeriesRejectReason,
    SeriesState,
...
from polymarket_trader.quant.series.sizing import (
    SeriesSubTypeSettings,
    series_subtype_settings,
    size_series_entry,
)
from polymarket_trader.quant.series.winner_model import (
