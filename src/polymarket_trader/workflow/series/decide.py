...
from polymarket_trader.workflow.series.evaluator import SeriesEvaluatorInputs, evaluate_series_opportunity
from polymarket_trader.workflow.series.risk import SeriesSubTypeRiskConfig, check_series_entry_risk
from polymarket_trader.workflow.series.sizing import series_subtype_settings
from polymarket_trader.workflow.series.types import SeriesCandidate, SeriesEvaluation
from polymarket_trader.workflow.trading.helpers import decimal_from_metadata
...
def _series_estimated_settlement_days(
    ...
    *,
    ...
    """
    from polymarket_trader.workflow.series.match import series_state_from_metadata
    from polymarket_trader.workflow.series.winner_model import expected_games_remaining
