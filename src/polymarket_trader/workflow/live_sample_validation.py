...
from polymarket_trader.config import load_mapping_file
from polymarket_trader.infra.sports import parse_goalserve_inplay
from polymarket_trader.serialization import jsonable
from polymarket_trader.workflow.live_state import best_live_match, live_event_metadata
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if len(args) != 1:
        print("usage: python -m polymarket_trader.workflow.live_sample_validation <fixture.json>", file=sys.stderr)
        return 2
