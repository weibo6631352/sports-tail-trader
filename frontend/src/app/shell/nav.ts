...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    links: [
      ...
      { path: '/live/positions', label: '持仓' },
      { path: '/live/orders', label: '开口订单' },
      { path: '/live/operations', label: '手工干预' },
    ],
  },
  {
    id: 'investigate',
    label: '复盘 Investigate',
    links: [
  ...
  },
  {
    ...
    links: [
      ...
      { path: '/analytics/edge-realization', label: 'Edge Realization', badge: 'P0' },
      { path: '/analytics/calibration', label: 'Calibration', badge: 'P0' },
  ...
  },
  {
    ...
    label: '系统 System',
    links: [
      { path: '/system/health', label: '健康' },
      { path: '/system/outbox', label: 'Outbox' },
